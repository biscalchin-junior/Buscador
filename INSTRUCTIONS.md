...
- **SuperAdmin**: Possui um painel exclusivo (`/superadmin`) para monitorar estatísticas globais, erros e gerenciar usuários.
...
4. Mantenha sempre a estética **Brutalista/Premium** (preto e branco, bordas sólidas, tipografia uppercase) ao editar o frontend.
